...
class Map(pygame.sprite.Sprite):
    def __init__(self, screen, w, h):
        ...
        self.screen = screen
        self.logo_path = rospkg.RosPack().get_path('xycar_sim_parking') + "/image/logo.png"
...
class Car(pygame.sprite.Sprite):
    def __init__(self, x, y, screen, angle=0.0, max_acceleration=1000.0):
        ...
        self.img_path = rospkg.RosPack().get_path('xycar_sim_parking') + "/image/car.png"
...
class Game:
    ...
    def run(self):
        ...
        #file_path = rospkg.RosPack().get_path("xycar_sim_parking")
        #last_modified = os.path.getmtime(file_path+"/src/simulator.so")
        #expiration_time = 40 * 24 * 60 * 60  # 40 days in seconds
        #expiration_time = 2 * 60 * 60
        #expiration_date = last_modified + expiration_time
        ...
        while not self.exit:
            ...
            #path tracking
            if self.d !=0:
                tracking(game.screen, car.x, car.y, car.yaw, car.linear_velocity, car.max_acceleration, dt)
